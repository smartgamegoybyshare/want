    ...
    public PageOneView_Logout(Context context) {
        ...
        Runnable getimage = () -> {
            ...
            if (Value.language_flag == 0) {  //flag = 0 => Eng, flag = 1 => Cht, flag = 2 => Chs
                imageUri = "https://dl.kz168168.com/img/omen-slider01_en.png";
            }else if(Value.language_flag == 1){
                imageUri = "https://dl.kz168168.com/img/omen-slider01_tw.png";
            }else if(Value.language_flag == 2){
                imageUri = "https://dl.kz168168.com/img/omen-slider01_cn.png";
            }
